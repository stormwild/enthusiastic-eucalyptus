...
var _seed = __webpack_require__(/*! ./scipts/seed */ "./server/db/scipts/seed.js");
...
_mongoose["default"].connection.once('open', function () {
  ...
  (0, _seed.initCourseCategories)();
  (0, _seed.initInstructors)();
  (0, _seed.initCourses)();
});

/***/ }),

/***/ "./server/db/scipts/seed.js":
/*!**********************************!*\
  !*** ./server/db/scipts/seed.js ***!
  \**********************************/
/*! no static exports found */
...
var initCourses = function initCourses() {
  _models.Course.countDocuments(function (err, count) {
    if (count == 0) {
      _models.Course.collection.insertMany(_courses["default"], function (err, docs) {
